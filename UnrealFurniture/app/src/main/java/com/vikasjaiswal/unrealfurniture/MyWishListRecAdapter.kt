...
class MyWishListRecAdapter : RecyclerView.Adapter<MyWishListRecAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val strikeText: TextView = itemView.findViewById(R.id.myWishListStrikeText)
        init {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        strikeText = v.findViewById(R.id.myWishListStrikeText)
        strikeText.paint.isStrikeThruText = true
